...
class AC_Custom_Cookie_Message
{
    ...
    function cookies_menu(){
        add_options_page(
            ...
            array($this, 'cookies_options_display') // The name of the function to call when rendering this menu's page
        );
    }
    ...
    function cookies_initialize_general_options(){
        ...
        add_settings_section(
            ...
            array($this,'cookies_general_options_callback'),    // Callback used to render the description of the section
        ...
        add_settings_field(
            ...
            array($this,'cookies_select_position_callback'),    // The name of the function responsible for rendering the option interface
