...
class AdminStylingOptions extends AdminForm {
	...
	public function cookies_initialize_styling_options() {
		...
		add_settings_section( 'styling_options_section', __( 'Styling Options', 'cookie-message' ), [ $this, 'cookies_styling_options_callback' ], 'cookies_styling_options' );

		add_settings_field( 'cookies_styling_options', __( 'Message container background', 'cookie-message' ), [ $this, 'cookies_message_color_picker_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Message Size', __( 'Message container padding top and bottom', 'cookie-message' ), [ $this, 'cookies_message_height_slider_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Opacity', __( 'Message container opacity', 'cookie-message' ), [ $this, 'cookies_opacity_slider_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'text_font', __( 'Text font', 'cookie-message' ), [ $this, 'cookies_text_font_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Text Color', __( 'Text Color', 'cookie-message' ), [ $this, 'cookies_text_color_picker_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Link Color', __( 'Link Color', 'cookie-message' ), [ $this, 'cookies_link_color_picker_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'add_button_class', __( 'Button classes', 'cookie-message' ), [ $this, 'cookies_add_button_class_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Button Color', __( 'Button Color', 'cookie-message' ), [ $this, 'cookies_button_color_picker_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Button Hover Color', __( 'Button Hover Color', 'cookie-message' ), [ $this, 'cookies_button_hover_color_picker_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'cookies_styling_options', __( 'Button Text Color', 'cookie-message' ), [ $this, 'cookies_button_text_color_picker_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'Button_height', __( 'Button Height', 'cookie-message' ), [ $this, 'cookies_button_height_slider_callback' ], 'cookies_styling_options', 'styling_options_section' );

		add_settings_field( 'button_width', __( 'Button Width', 'cookie-message' ), [ $this, 'cookies_button_width_slider_callback' ], 'cookies_styling_options', 'styling_options_section' );
