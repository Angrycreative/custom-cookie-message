...
<style>
	...
	<?php if(!empty( $styling_options['button_text_color_picker'] )){ ?> color: <?php echo $styling_options['button_text_color_picker'];?>;
	<?php } ?><?php if(!empty( $styling_options['button_hover_color_picker'] )){ ?> background-color: <?php echo $styling_options['button_hover_color_picker'];?>;
	<?php } ?>
	}
</style>
