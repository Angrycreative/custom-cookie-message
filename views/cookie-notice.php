...
<style>
    ...
    #cookies-button-ok.cookies-button-ok {
        ...
        <?php } ?>
        <?php if(!empty( $styling_options['button_height_slider_amount'] )){ ?>
            padding-top: <?php echo $styling_options['button_height_slider_amount'];?>px;
            padding-bottom: <?php echo $styling_options['button_height_slider_amount'];?>px;
        <?php } ?>
        <?php if(!empty( $styling_options['button_width_slider_amount'] )){ ?>
...
<div id="custom-cookie-message-container" class="container-cookies <?php echo $general_options['location_options']; ?>">
    ...
    <div class="warning-text"><p <?php echo ( empty( $styling_options['text_font'] ) ? '' : 'style=”font-family: ' .  $styling_options['text_font'] . '“'); ?> ><?php echo $content_options['textarea_warning_text'] ; ?> <a style="color: <?php echo $styling_options['link_color_picker'];?>" href=" <?php echo $general_options['cookies_page_link']; ?>" ><?php _e( $content_options['input_link_text'], 'cookie-message'); ?></a></p>
